<div align="center">
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=15&duration=3200&pause=800&color=4D8FCC&background=00000000&center=true&vCenter=true&width=640&lines=Windows+internals+%2F+kernel+dev;ngl+kernel+panics+at+3am+build+character;anticheat+RE+%2F+shellcode;btw+undefined+behavior+is+just+freestyling;GLSL+%2F+generative+systems;x86-64+assembly+%2F+reversing;LGTM+ship+it%2C+worst+case+corrupts+kernel+memory" alt="typing" />
</div>
...
<div align="center">
<img src="https://skillicons.dev/icons?i=cpp,rust,c,python,ts,go,powershell,linux,bash&perline=9" />
</div>
