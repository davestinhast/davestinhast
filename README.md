<div align="center"><img src="https://capsule-render.vercel.app/api?type=rect&color=0:0d1117,60:1a2f4a,100:0d1117&height=5&reversal=false" width="100%" /></div>
...
<sub>`C++` &nbsp; `Rust` &nbsp; `C` &nbsp; `x86-64 Assembly` &nbsp; `Python` &nbsp; `TypeScript` &nbsp; `Go` &nbsp; `GLSL` &nbsp; `PowerShell` &nbsp; `Linux`</sub>
